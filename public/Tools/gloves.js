const gloves=proxies.argumentCountChecker({
	...
	dummyStructure()
	{
		//No matter which key you reference, you just get another dummyStructure object
		//(Like an infinite structure of {aaaaa:{aaaaa:{aaaaa:{....}.....}....},aaaab:{....},aaaac:{...}....zzzzz:{}.......} etc
		//Example:
		//	d=dummyStructure()
		//	d.asd.asfsdfoi.sdfg.sdfg.sdfg===d.aoeijr.sdfj.sdf.woejr.sdf   --->   true
